...
const GA_MEASUREMENT_ID = "G-5NY2RMBK79";
...
function gtag_report_conversion(url) {
  ...
  gtag("event", "conversion", {
    send_to: "AW-17978217202/KJmkCO_urf8bEPKl1_xC",
    value: 0.1,
    currency: "AED",
...
(async function initDisplayAds() {
  ...
  const adSlots = [
    { adUnit: "/23330730517/gamioo5.com_d1", divId: "myw_top_1" },
    { adUnit: "/23330730517/gamioo5.com_d2", divId: "myw_top_2" },
    { adUnit: "/23330730517/gamioo5.com_d3", divId: "myw_top_3" },
  ];
    ...
    googletag.cmd.push(function () {
      try {
        ...
        currentSlot = googletag
          .defineOutOfPageSlot(
            "/23330730517/gamioo5.com_reward",
